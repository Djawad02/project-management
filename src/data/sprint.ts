...
const sprints: Sprint[] = [
    { id: 1, projectId: 1, sprintTitle: 'Sprint 1', startDate: '2024-07-01', endDate: '2024-07-15', description: 'Initial setup',status:'In Progress',task:[] },
    { id: 2, projectId: 2, sprintTitle: 'Sprint 1', startDate: '2024-07-10', endDate: '2024-08-01', description: 'Feature development' ,status:'Not Started',task:[]},
    { id: 3, projectId: 3, sprintTitle: 'Sprint 1', startDate: '2024-08-01', endDate: '2024-08-20', description: 'Backend development',status:'In Progress' ,task:[]},
    { id: 4, projectId: 4, sprintTitle: 'Sprint 1', startDate: '2024-09-01', endDate: '2024-09-15', description: 'Requirement analysis' ,status:'Not Started',task:[]},
    { id: 5, projectId: 5, sprintTitle: 'Sprint 1', startDate: '2024-07-20', endDate: '2024-08-05', description: 'Data collection',status:'In Progress' ,task:[]},
    { id: 6, projectId: 6, sprintTitle: 'Sprint 1', startDate: '2024-08-05', endDate: '2024-08-25', description: 'UI design',status:'Not Started' ,task:[]},
    { id: 7, projectId: 7, sprintTitle: 'Sprint 1', startDate: '2024-08-15', endDate: '2024-09-05', description: 'API development',status:'In Progress',task:[] },
